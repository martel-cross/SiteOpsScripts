...
Function writeMiscInfo
{
	...
	elseif ((!$F5fwd) -or ($F5fwd -like "F5ForwardedFor*")) {Add-Content $InspectorGadgetFile "<td bgcolor='#FF0000' align=center>$F5fwd</td>";$script:things_wrong++;$script:F5fwd_wrong+="<a href='#$server'>$server</a>, ";$script:F5fwd_wrong_count++} 
