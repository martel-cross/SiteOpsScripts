...
add-content stscan.csv $a
}

}


clear-content stscan.csv
...
getschedtasks $compname "ISS_Backup"
getschedtasks $compname "Clean app pool"
}}

}

# import-csv stscan.csv | foreach{
# $task = $_
...
# Send-MailMessage -to joel.terry@careerbuilder.com -from taskmonitor@careerbuilder.com -SmtpServer relay.careerbuilder.com -subject 'Scheduled Job Scan' -bodyashtml -body $report