...
$body = "New User: " + $emailaddress +"  Role Assigned: "+ $roleid
Send-MailMessage -to sitebackendalerts@careerbuilder.com -from SBELogicmonitor@careerbuilder.com -SmtpServer relay.careerbuilder.com -subject "New Logic Monitor User Setup" -body $body
}
...
Send-MailMessage -to sitebackend@careerbuilder.com -from SBELogicMonitor@careerbuilder.com -SmtpServer relay.careerbuilder.com -subject "LogicMonitor Errors" -body $body}