$pathfile = "C:\SiteOpsScripts\Misc\agent2.csv"
...
Send-MailMessage -to siteopsupport@careerbuilder.com -from kaseyaagent@careerbuilder.com -SmtpServer relay.careerbuilder.com -subject "Missing Kaseya Agent Report" -body "Report is attached" -attachment agent2.csv
