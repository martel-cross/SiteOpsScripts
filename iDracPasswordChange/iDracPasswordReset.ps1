...
#The script reads either IP addresses or domain names from a file called ipaddr.txt and will configure the iDRAC on each of those
...
function configDrac ($dracIP)
{
	writeLog "" iDracConfig
	writeLog "=================================================" iDracConfig
	writeLog "Resetting iDrac Password for $dracIP" iDracConfig
	writeLog "=================================================" iDracConfig
...
writeLog "Started iDrac Password Reset" iDracConfig
main
writeLog "" iDracConfig
...
writeLog "" iDracConfig
writeLog "iDrac Password Reset is Done." iDracConfig